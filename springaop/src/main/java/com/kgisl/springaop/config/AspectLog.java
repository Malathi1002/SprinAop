package com.kgisl.springaop.config;
...
public class AspectLog implements ThrowsAdvice {
    ...
    @Pointcut("execution(* com.kgisl.springaop.service.*.*(..))")
    public void controller() {
    }
    @Pointcut("execution(* com.kgisl.springaop.service.*.*(..))")
    protected void allMethod() {
    }
    @Before("execution(* com.kgisl.springaop.service.*.*(..))")
...
@AfterThrowing(pointcut="execution(* com.kgisl.springbdd.controller.*.*(..))", 
        throwing="excep")
